          ...
          <div className="left">
            ...
            {isLoadingUser ? (
              ...
              <div className="user">
                ...
                {!isNaN(data.totslStars / data.starNumber) && (
                  <div className="stars">
                    {Array(Math.round(data.totslStars / data.starNumber))
                      .fill()
                      .map((item, i) => (
                        <img src="/img/star.png" alt="" key={i} />
                      ))}
                    <span>{Math.round(data.totslStars / data.starNumber)}</span>
                  </div>
                )}
              </div>
            ) : null}
                  ...
                  <div className="info">
                    ...
                    {!isNaN(data.totslStars / data.starNumber) && (
                      <div className="stars">
                        ...
                        <span>
                          {Math.round(data.totslStars / data.starNumber)}
                        </span>
                      </div>
                    )}
